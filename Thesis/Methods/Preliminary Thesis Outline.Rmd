...
The previous model extends to the multivariate case where multiple longitudinal markers (eg. different bacteria taxa), and the latent process is the common factor underlying the markers.
